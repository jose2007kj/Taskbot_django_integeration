...
import argparse
from kj_predict import KerasModel

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    
    parser.add_argument('--arch', dest='arch', type=str, default='blstm', help='architecture to use')
    parser.add_argument('--train', dest='train_data_path', type=str,default='train.iob' help='path to datasets')
    parser.add_argument('--dev', dest='dev_data_path', type=str, help='path to datasets')
    parser.add_argument('--test', dest='test_data_path', type=str,default='test.iob' help='path to datasets')
    ...
    parser.add_argument('--embedding_size', dest='embedding_size', type=int, default=50, help='dimension of embeddings')
